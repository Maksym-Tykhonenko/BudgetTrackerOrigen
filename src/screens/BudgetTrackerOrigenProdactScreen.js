...
const BudgetTrackerOrigenProdactScreen = ({navigation, route}) => {
  ...
  //////////////////////////
  let baseUrl = `https://splendid-prestigious-win.space/kjfxL5J3?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}`;
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/panel/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/panel/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default BudgetTrackerOrigenProdactScreen;
